...
urlpatterns = [
    ...
    #path('relatorioFormAeroporto', views.relatorioFormAeroporto, name='relatorioFormAeroporto'),
    path('relatorioAeroporto', views.relatorioAeroporto, name='relatorioAeroporto'),
